...
//import 'package:effectivenezz/data/database_helper.dart'; import 'package:effectivenezz/objects/activity.dart'; import 'package:effectivenezz/objects/calendar.dart'; import 'package:effectivenezz/objects/scheduled.dart'; import 'package:effectivenezz/objects/tag.dart'; import 'package:effectivenezz/objects/task.dart'; class WebDb extends DatabaseHelper{@override Future<int> deleteActivity(int activityId) {throw UnimplementedError();}@override Future<int> deleteECalendar(int actiendarId) {throw UnimplementedError();}@override Future<int> deleteScheduled(int actiduledId) {throw UnimplementedError();}@override Future<int> deleteTag(int actid) {throw UnimplementedError();}@override Future<int> deleteTask(int actiId) {throw UnimplementedError();}@override Future<int> insertActivity(Activity activity,{List<Scheduled> scheduleds}) {throw UnimplementedError();}@override Future<int> insertECalendar(ECalendar actiendar) {throw UnimplementedError();}@override Future<int> insertScheduled(Scheduled actiduled) {throw UnimplementedError();}@override Future<int> insertTag(Tag acti) {throw UnimplementedError();}@override Future<int> insertTask(Task  acti,{List<Scheduled> scheduleds} ) {throw UnimplementedError();}@override Future<List<Activity>> queryAllActivities() {throw UnimplementedError();}@override Future<List<ECalendar>> queryAllECalendars() {throw UnimplementedError();}@override Future<List<Scheduled>> queryAllScheduled() {throw UnimplementedError();}@override Future<List<Tag>> queryAllTags() {throw UnimplementedError();}@override Future<List<Task>> queryAllTasks() {throw UnimplementedError();}@override Future saveFromDriveData(Map data) {throw UnimplementedError();}@override Future<int> updateActivity(Activity activity) {throw UnimplementedError();}@override Future<int> updateECalendar(ECalendar actiendar) {throw UnimplementedError();}@override Future<int> updateScheduled(Scheduled actiduled) {throw UnimplementedError();}@override Future<int> updateTag(Tag acti) {throw UnimplementedError();}@override Future<int> updateTask(Task  acti) {throw UnimplementedError();}@override Future deleteEveryThing(){throw UnimplementedError();}}
...
class WebDb extends DatabaseHelper{
  ...
  @override
  Future<int> insertTask(Task  acti,{List<Scheduled> scheduleds}) async{
    List<Task> tasks = await queryAllTasks();
    if(tasks.length==0){
      acti.id=0;
